  ...
  <div class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow rounded-lg">
      <div class="px-4 py-5 sm:p-6">
        ...
        <!-- SSO User Message -->
        <div v-if="isSSOUser" class="rounded-md bg-blue-50 p-4 mb-6">
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <div class="mt-2 text-sm text-blue-700">
                <p>Your account is managed through Google Sign-In. Password changes are handled through your Google account settings.</p>
                <p class="mt-2">Please visit <a href="https://myaccount.google.com/security" target="_blank" class="underline hover:text-blue-800 font-medium">myaccount.google.com/security</a> to change your password.</p>
              </div>
            </div>
          </div>
        </div>
        
        <form v-if="!isSSOUser" @submit.prevent="handleChangePassword" class="space-y-6">
          <div>
...
// Computed transmitted to check if user is authenticated via SSO (Google)
