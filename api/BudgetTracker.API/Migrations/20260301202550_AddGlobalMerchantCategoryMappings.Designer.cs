...
namespace BudgetTracker.API.Migrations
{
    ...
    [Migration("20260301202550_AddGlobalMerchantCategoryMappings")]
    partial class AddGlobalMerchantCategoryMappings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetTracker.Common.Models.GlobalMerchantCategoryMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GlobalMerchantCategoryMappings");
                });
            ...
            modelBuilder.Entity("BudgetTracker.Common.Models.Transaction", b =>
                {
                    ...
                    b.HasIndex("UserId", "TransactionHash");
            ...
            modelBuilder.Entity("BudgetTracker.Common.Models.UserMerchantCategoryMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserMerchantCategoryMappings");
                });

            modelBuilder.Entity("BudgetTracker.Observability.Models.ApplicationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
